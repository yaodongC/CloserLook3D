...
def edict2dict(config):
    ...
    in_features_dim=config.in_features_dim ,
    bottleneck_ratio=config.bottleneck_ratio ,
    depth=config.depth ,
    first_features_dim=config.first_features_dim ,
    ...
    # data augmentation
    augment_scale_anisotropic=config.augment_scale_anisotropic,
